  ...
  return (
    <div className='bg-[#1C1C1C] mt-6 rounded h-86 p-5' >
      ...
      <div className='flex items-center bg-red-400 mb-2 rounded justify-between py-2 px-4'>
        <h2 className='text-lg w-1/5 bg-red-700'> Employee Name</h2>
        <h3 className='text-lg w-1/5 bg-red-700'>New Task</h3>
        <h5 className='text-lg w-1/5 bg-red-700'>Active Task</h5>
        <h5 className='text-lg w-1/5 bg-red-700'>Completed</h5>
        <h5 className='text-lg w-1/5 bg-red-700'>Failed</h5>
