...
const CreateTask = () => {
  return (
    <div className='text-white  bg-[#1C1C1C] mt-7 rounded p-6'>
        ...
        <textarea className='w-full h-40  py-2 px-4 rounded outline-none border-[1px] border-emerald-500 bg-transparent' placeholder='Detailed description of the task'/>
