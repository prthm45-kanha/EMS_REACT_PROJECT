...
const FailedTask = ({data}) => {
  return (
    ...
    <div className='h-full flex-shrink-0 w-[300px] p-5 bg-emerald-700 rounded-xl '>
          ...
          <p className='text-gray-200 text-sm mt-2'> {data.taskDescription} </p>
            ...
            <div className='mt-5'>
            <button className='bg-red-500 text-white py-1 px-2 text-sm rounded hover:bg-red-600'>Failed</button>
          </div>
      </div>
  );
};
